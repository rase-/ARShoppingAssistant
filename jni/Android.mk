...
LOCAL_SHARED_LIBRARIES += ../tess-two/tess-two/libs/armeabi-v7a/libtess.so
...
LOCAL_SRC_FILES := native.cpp nonfree_init.cpp precomp.cpp sift.cpp surf.cpp product_matcher.cpp product.cpp
